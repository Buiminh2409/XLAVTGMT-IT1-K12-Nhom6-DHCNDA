...
knn = KNeighborsClassifier(n_neighbors=3)  # Số hàng xóm = 3
...
def select_and_process_image():
    ...
    # Tính các chỉ số hiệu suất trên tập kiểm thử
    ...
    # Tách giao diện thành hai phần (Frame)
    ...
    # Hiển thị các chỉ số về phân tích ở bên phải
    info_text = (
